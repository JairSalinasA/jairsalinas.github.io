...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | J.B SALBET";
        $("#favicon").attr("href","./assests/images/pngtree.png");
    }
    else {
        document.title = "!Hey¡ regresa a mi  Portfolio";
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["Full-Stack development", "Machine Learning", "Cloud Computing", "Tech Communities","Programming","ASP.NET MVC","Client-side web development","Database management","SQL","Oracle","Unit testing","AJAX","HTML", "CSS", "JavaScript","jQuery","Debugging"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
